...
class _Node23:
    ...
    def insert(self, key):
        ...
        if len(self.keys) == 3:
            print("g")
            left_split = _Node23(self.keys[0], self.trees[0:2])
            right_split = _Node23(self.keys[2], self.trees[2:])
            return self.keys[1], left_split, right_split
